...
.method static shouldShowDialogInForeground(Landroid/content/Context;Ljava/lang/String;)Z
    ...
    .line 67
    .local v8, "manager":Lcom/android/settingslib/bluetooth/LocalBluetoothManager;
    if-nez v8, :cond_0

    .line 68
    const-string/jumbo v10, "LocalBluetoothPreferences"

    const-string/jumbo v11, "manager == null - do not show dialog."
    ...
    const-string/jumbo v11, "in appliance mode - do not show dialog."
    ...
    const-string/jumbo v10, "discoverable_end_timestamp"
    ...
    .line 99
    :cond_4
    const-string/jumbo v10, "last_discovering_time"
    ...
    .line 107
    const-string/jumbo v10, "last_selected_device"
    ...
    .line 111
    const-string/jumbo v10, "last_selected_device_time"
    ...
    const-string/jumbo v11, "Found no reason to show the dialog - do not show dialog."
