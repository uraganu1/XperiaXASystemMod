...
.method public init(Lcom/android/settings/SettingsPreferenceFragment;)Landroid/preference/Preference;
    ...
    iget-object v4, p0, Lcom/android/settings/notification/SettingPref;->mKey:Ljava/lang/String;
    ...
    iput-object v3, p0, Lcom/android/settings/notification/SettingPref;->mTwoState:Landroid/preference/TwoStatePreference;
    ...
    .line 81
    new-instance v3, Lcom/android/settings/notification/SettingPref$1;

    invoke-direct {v3, p0, v0}, Lcom/android/settings/notification/SettingPref$1;-><init>(Lcom/android/settings/notification/SettingPref;Landroid/content/Context;)V
    ...
    .end local v1    # "p":Landroid/preference/Preference;
    :cond_3
    instance-of v3, v1, Lcom/android/settings/DropDownPreference;
    ...
    iput-object v3, p0, Lcom/android/settings/notification/SettingPref;->mDropDown:Lcom/android/settings/DropDownPreference;

    .line 75
    iget-object v4, p0, Lcom/android/settings/notification/SettingPref;->mValues:[I
    ...
    invoke-virtual {p0, v7, v2}, Lcom/android/settings/notification/SettingPref;->getCaption(Landroid/content/res/Resources;I)Ljava/lang/String;
    ...
    :cond_4
    iget-object v3, p0, Lcom/android/settings/notification/SettingPref;->mDropDown:Lcom/android/settings/DropDownPreference;
    ...
    new-instance v4, Lcom/android/settings/notification/SettingPref$2;

    invoke-direct {v4, p0, v0}, Lcom/android/settings/notification/SettingPref$2;-><init>(Lcom/android/settings/notification/SettingPref;Landroid/content/Context;)V
