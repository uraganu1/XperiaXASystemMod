...
.method private handleWriteNfcEvent(Landroid/nfc/Tag;)V
    ...
    iput-boolean v4, p0, Lcom/android/settings/wifi/WriteWifiConfigToNfcDialog;->mNFCTagWritingSucceed:Z
    :try_end_0
...
.method public dismiss()V
    ...
    const-string/jumbo v2, "it\'s dismiss(),release the wakelock="
...
.method public onClick(Landroid/view/View;)V
    ...
    .line 168
    sget-object v7, Lcom/android/settings/wifi/WriteWifiConfigToNfcDialog;->TAG:Ljava/lang/String;

    new-instance v8, Ljava/lang/StringBuilder;

    invoke-direct {v8}, Ljava/lang/StringBuilder;-><init>()V

    const-string/jumbo v9, "it\'s onClick(),release the wakelock="

    invoke-virtual {v8, v9}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v8

    iget-object v9, p0, Lcom/android/settings/wifi/WriteWifiConfigToNfcDialog;->mWakeLock:Landroid/os/PowerManager$WakeLock;
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    const-string/jumbo v3, "it\'s onCreate(),release the wakelock="
...
.method public onSaveInstanceState()Landroid/os/Bundle;
    ...
    const-string/jumbo v2, "it\'s onSaveInstanceState(),release the wakelock="
...
.method public onStop()V
    ...
    const-string/jumbo v4, "it\'s onStop(),release the wakelock="
    ...
    .line 144
    :cond_0
    iget-boolean v2, p0, Lcom/android/settings/wifi/WriteWifiConfigToNfcDialog;->mNFCTagWritingSucceed:Z
    ...
    iput-boolean v2, p0, Lcom/android/settings/wifi/WriteWifiConfigToNfcDialog;->mNFCTagWritingSucceed:Z
