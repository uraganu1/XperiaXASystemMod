...
.method static synthetic -get4(Lcom/android/settings/TrustedCredentialsSettings$Tab;)Z
    .locals 1
...
.method static synthetic -get5(Lcom/android/settings/TrustedCredentialsSettings$Tab;)Ljava/lang/String;
    .locals 1
...
.method private static synthetic -getcom_android_settings_TrustedCredentialsSettings$TabSwitchesValues()[I
    ...
    sget-object v0, Lcom/android/settings/TrustedCredentialsSettings$Tab;->-com_android_settings_TrustedCredentialsSettings$TabSwitchesValues:[I
    ...
    :goto_1
    sput-object v0, Lcom/android/settings/TrustedCredentialsSettings$Tab;->-com_android_settings_TrustedCredentialsSettings$TabSwitchesValues:[I
...
.method static synthetic -wrap1(Lcom/android/settings/TrustedCredentialsSettings$Tab;Lcom/android/settings/TrustedCredentialsSettings$CertHolder;)I
    .locals 1
...
.method static synthetic -wrap2(Lcom/android/settings/TrustedCredentialsSettings$Tab;Lcom/android/settings/TrustedCredentialsSettings$CertHolder;)I
    .locals 1
    .param p1, "certHolder"    # Lcom/android/settings/TrustedCredentialsSettings$CertHolder;
...
.method static synthetic -wrap3(Lcom/android/settings/TrustedCredentialsSettings$Tab;Landroid/security/IKeyChainService;)Ljava/util/List;
    .locals 1
    .param p1, "service"    # Landroid/security/IKeyChainService;
...
.method static synthetic -wrap4(Lcom/android/settings/TrustedCredentialsSettings$Tab;ZLcom/android/settings/TrustedCredentialsSettings$CertHolder;)V
    .locals 0
    .param p1, "ok"    # Z
...
.method private deleted(Landroid/security/IKeyChainService;Ljava/lang/String;)Z
    ...
    .line 123
    invoke-static {}, Lcom/android/settings/TrustedCredentialsSettings$Tab;->-getcom_android_settings_TrustedCredentialsSettings$TabSwitchesValues()[I
...
.method private postOperationUpdate(ZLcom/android/settings/TrustedCredentialsSettings$CertHolder;)V
    ...
    .line 157
    invoke-static {p2}, Lcom/android/settings/TrustedCredentialsSettings$CertHolder;->-get5(Lcom/android/settings/TrustedCredentialsSettings$CertHolder;)Lcom/android/settings/TrustedCredentialsSettings$Tab;
    ...
    .line 158
    invoke-static {p2}, Lcom/android/settings/TrustedCredentialsSettings$CertHolder;->-get2(Lcom/android/settings/TrustedCredentialsSettings$CertHolder;)Z
    ...
    :goto_0
    invoke-static {p2, v0}, Lcom/android/settings/TrustedCredentialsSettings$CertHolder;->-set0(Lcom/android/settings/TrustedCredentialsSettings$CertHolder;Z)Z

    .line 162
    :goto_1
    invoke-static {p2}, Lcom/android/settings/TrustedCredentialsSettings$CertHolder;->-get0(Lcom/android/settings/TrustedCredentialsSettings$CertHolder;)Lcom/android/settings/TrustedCredentialsSettings$TrustedCertificateAdapterCommons;
