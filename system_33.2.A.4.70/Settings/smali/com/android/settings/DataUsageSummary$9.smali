...
.method public onLoadFinished(Landroid/content/Loader;Lcom/android/settings/net/ChartData;)V
    ...
    const-string/jumbo v2, "onLoadFinished, mChartData.network: "

    invoke-virtual {v1, v2}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v1

    iget-object v2, p2, Lcom/android/settings/net/ChartData;->network:Landroid/net/NetworkStatsHistory;

    invoke-virtual {v1, v2}, Ljava/lang/StringBuilder;->append(Ljava/lang/Object;)Ljava/lang/StringBuilder;

    move-result-object v1

    const-string/jumbo v2, "mChartData.detail"
    ...
    .line 1779
    iget-object v2, p2, Lcom/android/settings/net/ChartData;->detail:Landroid/net/NetworkStatsHistory;
    ...
    invoke-static {v0, p2}, Lcom/android/settings/DataUsageSummary;->-set1(Lcom/android/settings/DataUsageSummary;Lcom/android/settings/net/ChartData;)Lcom/android/settings/net/ChartData;

    .line 1781
    iget-object v0, p0, Lcom/android/settings/DataUsageSummary$9;->this$0:Lcom/android/settings/DataUsageSummary;

    invoke-static {v0}, Lcom/android/settings/DataUsageSummary;->-get4(Lcom/android/settings/DataUsageSummary;)Lcom/android/settings/widget/ChartDataUsageView;

    move-result-object v0

    iget-object v1, p0, Lcom/android/settings/DataUsageSummary$9;->this$0:Lcom/android/settings/DataUsageSummary;

    invoke-static {v1}, Lcom/android/settings/DataUsageSummary;->-get5(Lcom/android/settings/DataUsageSummary;)Lcom/android/settings/net/ChartData;
    ...
    invoke-virtual {v0, v1}, Lcom/android/settings/DataUsageSummary;->updatePolicy(Z)V
    ...
    invoke-static {v0}, Lcom/android/settings/DataUsageSummary;->-get5(Lcom/android/settings/DataUsageSummary;)Lcom/android/settings/net/ChartData;
...
.method public bridge synthetic onLoadFinished(Landroid/content/Loader;Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, p1, p2}, Lcom/android/settings/DataUsageSummary$9;->onLoadFinished(Landroid/content/Loader;Lcom/android/settings/net/ChartData;)V
...
.method public onLoaderReset(Landroid/content/Loader;)V
    ...
    invoke-static {v0, v1}, Lcom/android/settings/DataUsageSummary;->-set1(Lcom/android/settings/DataUsageSummary;Lcom/android/settings/net/ChartData;)Lcom/android/settings/net/ChartData;
