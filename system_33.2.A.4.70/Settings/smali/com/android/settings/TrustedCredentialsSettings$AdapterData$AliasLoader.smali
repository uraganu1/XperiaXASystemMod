...
.method public constructor <init>(Lcom/android/settings/TrustedCredentialsSettings$AdapterData;)V
    ...
    invoke-static {v0}, Lcom/android/settings/TrustedCredentialsSettings;->-get0(Lcom/android/settings/TrustedCredentialsSettings;)Ljava/util/HashMap;

    move-result-object v0

    invoke-static {p1}, Lcom/android/settings/TrustedCredentialsSettings$AdapterData;->-get2(Lcom/android/settings/TrustedCredentialsSettings$AdapterData;)Lcom/android/settings/TrustedCredentialsSettings$Tab;
...
.method protected varargs doInBackground([Ljava/lang/Void;)Landroid/util/SparseArray;
    ...
    invoke-static {v2}, Lcom/android/settings/TrustedCredentialsSettings;->-get3(Lcom/android/settings/TrustedCredentialsSettings;)Landroid/os/UserManager;
    ...
    invoke-static {v2}, Lcom/android/settings/TrustedCredentialsSettings;->-get1(Lcom/android/settings/TrustedCredentialsSettings;)Landroid/util/SparseArray;
    ...
    invoke-static {v2, v3}, Lcom/android/settings/TrustedCredentialsSettings$Tab;->-wrap3(Lcom/android/settings/TrustedCredentialsSettings$Tab;Landroid/security/IKeyChainService;)Ljava/util/List;
    ...
    invoke-static {v4}, Lcom/android/settings/TrustedCredentialsSettings$AdapterData;->-get0(Lcom/android/settings/TrustedCredentialsSettings$AdapterData;)Lcom/android/settings/TrustedCredentialsSettings$TrustedCertificateAdapterCommons;
...
.method protected onPostExecute(Landroid/util/SparseArray;)V
    ...
    invoke-static {v2}, Lcom/android/settings/TrustedCredentialsSettings$AdapterData;->-get0(Lcom/android/settings/TrustedCredentialsSettings$AdapterData;)Lcom/android/settings/TrustedCredentialsSettings$TrustedCertificateAdapterCommons;
    ...
    invoke-static {v2}, Lcom/android/settings/TrustedCredentialsSettings;->-get0(Lcom/android/settings/TrustedCredentialsSettings;)Ljava/util/HashMap;
    ...
    invoke-static {v3}, Lcom/android/settings/TrustedCredentialsSettings$AdapterData;->-get2(Lcom/android/settings/TrustedCredentialsSettings$AdapterData;)Lcom/android/settings/TrustedCredentialsSettings$Tab;
...
.method protected onPreExecute()V
    ...
    invoke-static {v1}, Lcom/android/settings/TrustedCredentialsSettings;->-get2(Lcom/android/settings/TrustedCredentialsSettings;)Landroid/widget/TabHost;
    ...
    invoke-static {v1}, Lcom/android/settings/TrustedCredentialsSettings$Tab;->-get3(Lcom/android/settings/TrustedCredentialsSettings$Tab;)I
    ...
    invoke-static {v1}, Lcom/android/settings/TrustedCredentialsSettings$AdapterData;->-get0(Lcom/android/settings/TrustedCredentialsSettings$AdapterData;)Lcom/android/settings/TrustedCredentialsSettings$TrustedCertificateAdapterCommons;
