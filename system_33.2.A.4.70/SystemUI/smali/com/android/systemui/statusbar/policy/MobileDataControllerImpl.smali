...
.method private findNetworkPolicy(Landroid/net/NetworkTemplate;)Landroid/net/NetworkPolicy;
    ...
    .line 176
    iget-object v4, p0, Lcom/android/systemui/statusbar/policy/MobileDataControllerImpl;->mPolicyManager:Landroid/net/NetworkPolicyManager;
...
.method private getSession()Landroid/net/INetworkStatsSession;
    ...
    .prologue
    .line 81
    iget-object v2, p0, Lcom/android/systemui/statusbar/policy/MobileDataControllerImpl;->mSession:Landroid/net/INetworkStatsSession;

    if-nez v2, :cond_0

    .line 83
    :try_start_0
    iget-object v2, p0, Lcom/android/systemui/statusbar/policy/MobileDataControllerImpl;->mStatsService:Landroid/net/INetworkStatsService;

    invoke-interface {v2}, Landroid/net/INetworkStatsService;->openSession()Landroid/net/INetworkStatsSession;

    move-result-object v2

    iput-object v2, p0, Lcom/android/systemui/statusbar/policy/MobileDataControllerImpl;->mSession:Landroid/net/INetworkStatsSession;
    :try_end_0
...
.method public getDataUsageInfo()Lcom/android/systemui/statusbar/policy/NetworkController$MobileDataController$DataUsageInfo;
    ...
    .line 112
    const-string/jumbo v12, "no subscriber id"
    ...
    const-string/jumbo v12, "MobileDataController"

    new-instance v27, Ljava/lang/StringBuilder;

    invoke-direct/range {v27 .. v27}, Ljava/lang/StringBuilder;-><init>()V

    const-string/jumbo v28, "Cycle day="
    ...
    const-string/jumbo v27, "history call from %s to %s now=%s took %sms: %s"
...
.method public isDefaultDataSimExist()Z
    .locals 7
    ...
    const-string/jumbo v6, "isDefaultDataSimExist, Default data sub id : "
...
.method public setMobileDataEnabled(Z)V
    ...
    const-string/jumbo v6, "setMobileDataEnabled: enabled="
    ...
    .line 204
    iget-object v3, p0, Lcom/android/systemui/statusbar/policy/MobileDataControllerImpl;->mTelephonyManager:Landroid/telephony/TelephonyManager;
    ...
    iget-object v6, p0, Lcom/android/systemui/statusbar/policy/MobileDataControllerImpl;->mTelephonyManager:Landroid/telephony/TelephonyManager;

    invoke-virtual {v6, v1}, Landroid/telephony/TelephonyManager;->getDataEnabled(I)Z
    ...
    invoke-virtual {v6, v1, v4}, Landroid/telephony/TelephonyManager;->setDataEnabled(IZ)V
    ...
    :cond_1
    iget-object v3, p0, Lcom/android/systemui/statusbar/policy/MobileDataControllerImpl;->mCallback:Lcom/android/systemui/statusbar/policy/MobileDataControllerImpl$Callback;
    ...
    invoke-interface {v3, p1}, Lcom/android/systemui/statusbar/policy/MobileDataControllerImpl$Callback;->onMobileDataEnabled(Z)V
