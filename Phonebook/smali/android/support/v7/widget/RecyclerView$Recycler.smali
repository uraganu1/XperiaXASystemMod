...
.method dispatchViewRecycled(Landroid/support/v7/widget/RecyclerView$ViewHolder;)V
    ...
    invoke-static {v0}, Landroid/support/v7/widget/RecyclerView;->-get12(Landroid/support/v7/widget/RecyclerView;)Landroid/support/v7/widget/RecyclerView$RecyclerListener;
...
.method getScrapViewForPosition(IIZ)Landroid/support/v7/widget/RecyclerView$ViewHolder;
    ...
    invoke-static {v5}, Landroid/support/v7/widget/RecyclerView$State;->-get1(Landroid/support/v7/widget/RecyclerView$State;)Z
...
.method getViewForPosition(IZ)Landroid/view/View;
    ...
    invoke-virtual {p0, p1, v9, p2}, Landroid/support/v7/widget/RecyclerView$Recycler;->getScrapViewForPosition(IIZ)Landroid/support/v7/widget/RecyclerView$ViewHolder;
    ...
    invoke-virtual {v9, v10, v8}, Landroid/support/v7/widget/RecyclerView;->removeDetachedView(Landroid/view/View;Z)V
    ...
    invoke-virtual {v9, p1}, Landroid/support/v7/widget/AdapterHelper;->findPositionOffset(I)I
    ...
    invoke-static {v9}, Landroid/support/v7/widget/RecyclerView;->-get2(Landroid/support/v7/widget/RecyclerView;)Landroid/support/v7/widget/RecyclerView$Adapter;
    ...
    invoke-virtual {v9, v4}, Landroid/support/v7/widget/RecyclerView$Adapter;->getItemViewType(I)I
    ...
    invoke-virtual {v9, v4}, Landroid/support/v7/widget/RecyclerView$Adapter;->getItemId(I)J
    ...
    iget-object v9, p0, Landroid/support/v7/widget/RecyclerView$Recycler;->mViewCacheExtension:Landroid/support/v7/widget/RecyclerView$ViewCacheExtension;
    ...
    invoke-virtual {v9, p0, p1, v6}, Landroid/support/v7/widget/RecyclerView$ViewCacheExtension;->getViewForPositionAndType(Landroid/support/v7/widget/RecyclerView$Recycler;II)Landroid/view/View;
    ...
    invoke-virtual {v9, v7}, Landroid/support/v7/widget/RecyclerView;->getChildViewHolder(Landroid/view/View;)Landroid/support/v7/widget/RecyclerView$ViewHolder;
    ...
    invoke-virtual {v9, v6}, Landroid/support/v7/widget/RecyclerView$RecycledViewPool;->getRecycledView(I)Landroid/support/v7/widget/RecyclerView$ViewHolder;
    ...
    invoke-virtual {v9, v10, v6}, Landroid/support/v7/widget/RecyclerView$Adapter;->createViewHolder(Landroid/view/ViewGroup;I)Landroid/support/v7/widget/RecyclerView$ViewHolder;
    ...
    invoke-virtual {v9}, Landroid/support/v7/widget/RecyclerView;->generateDefaultLayoutParams()Landroid/view/ViewGroup$LayoutParams;
    ...
    :goto_5
    iput-boolean v0, v5, Landroid/support/v7/widget/RecyclerView$LayoutParams;->mPendingInvalidate:Z
    ...
    iput-object v9, v2, Landroid/support/v7/widget/RecyclerView$ViewHolder;->mOwnerRecyclerView:Landroid/support/v7/widget/RecyclerView;
    ...
    invoke-virtual {v9, v2, v4}, Landroid/support/v7/widget/RecyclerView$Adapter;->bindViewHolder(Landroid/support/v7/widget/RecyclerView$ViewHolder;I)V

    .line 4569
    iget-object v9, v2, Landroid/support/v7/widget/RecyclerView$ViewHolder;->itemView:Landroid/view/View;

    invoke-direct {p0, v9}, Landroid/support/v7/widget/RecyclerView$Recycler;->attachAccessibilityDelegate(Landroid/view/View;)V
    ...
    invoke-virtual {v9, v3}, Landroid/support/v7/widget/RecyclerView;->checkLayoutParams(Landroid/view/ViewGroup$LayoutParams;)Z
    ...
    invoke-virtual {v9, v3}, Landroid/support/v7/widget/RecyclerView;->generateLayoutParams(Landroid/view/ViewGroup$LayoutParams;)Landroid/view/ViewGroup$LayoutParams;
...
.method quickRecycleScrapView(Landroid/view/View;)V
    ...
    invoke-static {v0, v1}, Landroid/support/v7/widget/RecyclerView$ViewHolder;->-set0(Landroid/support/v7/widget/RecyclerView$ViewHolder;Landroid/support/v7/widget/RecyclerView$Recycler;)Landroid/support/v7/widget/RecyclerView$Recycler;
...
.method scrapView(Landroid/view/View;)V
    ...
    invoke-static {v1}, Landroid/support/v7/widget/RecyclerView;->-wrap2(Landroid/support/v7/widget/RecyclerView;)Z
...
.method unscrapView(Landroid/support/v7/widget/RecyclerView$ViewHolder;)V
    ...
    invoke-static {v0}, Landroid/support/v7/widget/RecyclerView;->-wrap2(Landroid/support/v7/widget/RecyclerView;)Z
    ...
    .line 4819
    :goto_0
    invoke-static {p1, v1}, Landroid/support/v7/widget/RecyclerView$ViewHolder;->-set0(Landroid/support/v7/widget/RecyclerView$ViewHolder;Landroid/support/v7/widget/RecyclerView$Recycler;)Landroid/support/v7/widget/RecyclerView$Recycler;
