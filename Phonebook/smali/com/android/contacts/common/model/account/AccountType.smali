...
.field public aliasNames:Ljava/util/ArrayList;
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lcom/android/contacts/common/model/account/AccountType;->aliasNames:Ljava/util/ArrayList;
...
.method public abstract areContactsCopyable()Z
.end method
...
.method public getDisplayIcon(Landroid/content/Context;)Landroid/graphics/drawable/Drawable;
    ...
    .prologue
    .line 335
    iget v0, p0, Lcom/android/contacts/common/model/account/AccountType;->iconRes:I

    invoke-virtual {p0, p1, v0}, Lcom/android/contacts/common/model/account/AccountType;->getDisplayIconForIconId(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
...
.method protected getDisplayIconForIconId(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    .locals 5
    .param p1, "context"    # Landroid/content/Context;
    .param p2, "iconId"    # I
    ...
    invoke-virtual {v1, v2, p2, v3}, Landroid/content/pm/PackageManager;->getDrawable(Ljava/lang/String;ILandroid/content/pm/ApplicationInfo;)Landroid/graphics/drawable/Drawable;
    ...
    const-string/jumbo v3, "Error for account display icon: "
...
.method public getDisplayIconForResId(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    .locals 1
    .param p1, "context"    # Landroid/content/Context;
    .param p2, "altIconResId"    # I

    .prologue
    .line 347
    invoke-virtual {p0, p1, p2}, Lcom/android/contacts/common/model/account/AccountType;->getDisplayIconForIconId(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
...
.method public getSortedDataKinds()Ljava/util/concurrent/CopyOnWriteArrayList;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
    ...
    iget-object v1, p0, Lcom/android/contacts/common/model/account/AccountType;->mKinds:Ljava/util/ArrayList;
