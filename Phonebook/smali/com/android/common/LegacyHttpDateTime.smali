...
.method private static getTime(Ljava/lang/String;)Lcom/android/common/LegacyHttpDateTime$TimeOfDay;
    ...
    .line 223
    .local v4, "second":I
    new-instance v5, Lcom/android/common/LegacyHttpDateTime$TimeOfDay;

    invoke-direct {v5, v0, v3, v4}, Lcom/android/common/LegacyHttpDateTime$TimeOfDay;-><init>(III)V
...
.method public static parse(Ljava/lang/String;)J
    ...
    .line 93
    .local v6, "year":I
    sget-object v1, Lcom/android/common/LegacyHttpDateTime;->HTTP_DATE_RFC_PATTERN:Ljava/util/regex/Pattern;
    ...
    invoke-static {v1}, Lcom/android/common/LegacyHttpDateTime;->getDate(Ljava/lang/String;)I
    ...
    invoke-static {v1}, Lcom/android/common/LegacyHttpDateTime;->getYear(Ljava/lang/String;)I
    ...
    invoke-static {v1}, Lcom/android/common/LegacyHttpDateTime;->getTime(Ljava/lang/String;)Lcom/android/common/LegacyHttpDateTime$TimeOfDay;

    move-result-object v9

    .line 112
    .local v9, "timeOfDay":Lcom/android/common/LegacyHttpDateTime$TimeOfDay;
    :goto_0
    const/16 v1, 0x7f6
    ...
    iget v1, v9, Lcom/android/common/LegacyHttpDateTime$TimeOfDay;->second:I

    iget v2, v9, Lcom/android/common/LegacyHttpDateTime$TimeOfDay;->minute:I

    iget v3, v9, Lcom/android/common/LegacyHttpDateTime$TimeOfDay;->hour:I
    ...
    .end local v9    # "timeOfDay":Lcom/android/common/LegacyHttpDateTime$TimeOfDay;
    :cond_1
    sget-object v1, Lcom/android/common/LegacyHttpDateTime;->HTTP_DATE_ANSIC_PATTERN:Ljava/util/regex/Pattern;
    ...
    .line 105
    .restart local v9    # "timeOfDay":Lcom/android/common/LegacyHttpDateTime$TimeOfDay;
