...
.method private update(Ljava/util/Collection;Ljava/util/Collection;Ljava/lang/String;)Z
    ...
    const-string/jumbo v14, "Given list for data IDs is null. Ignoring."
    ...
    const-string/jumbo v15, "update toward data rows "
    ...
    const-string/jumbo v14, "Given list for contact IDs is null. Ignoring."
    ...
    .line 233
    .local v5, "questionMarks":[Ljava/lang/String;
    invoke-interface/range {p1 .. p1}, Ljava/lang/Iterable;->iterator()Ljava/util/Iterator;

    move-result-object v4

    .local v4, "contactId$iterator":Ljava/util/Iterator;
    :goto_1
    ...
    invoke-static {v5, v13}, Ljava/util/Arrays;->fill([Ljava/lang/Object;Ljava/lang/Object;)V

    .line 237
    const-string/jumbo v13, "_id IN ("
    ...
    invoke-static {v14, v5}, Landroid/text/TextUtils;->join(Ljava/lang/CharSequence;[Ljava/lang/Object;)Ljava/lang/String;
    ...
    const-string/jumbo v15, "contactId where: "
    ...
    const-string/jumbo v15, "contactId selection: "
    ...
    const-string/jumbo v13, "last_time_contacted"
    ...
    const-string/jumbo v15, "update toward raw contacts "
...
.method public updateWithAddress(Ljava/util/Collection;)Z
    ...
    .line 117
    const-string/jumbo v0, "data1 IN ("
    ...
    const-string/jumbo v1, "Cursor for Email.CONTENT_URI became null."
...
.method public updateWithPhoneNumber(Ljava/util/Collection;)Z
    ...
    const-string/jumbo v1, "Cursor for Phone.CONTENT_URI became null."
