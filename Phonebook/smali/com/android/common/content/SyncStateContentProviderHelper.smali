...
.method public createDatabase(Landroid/database/sqlite/SQLiteDatabase;)V
    ...
    .prologue
    .line 55
    const-string/jumbo v1, "DROP TABLE IF EXISTS _sync_state"

    invoke-virtual {p1, v1}, Landroid/database/sqlite/SQLiteDatabase;->execSQL(Ljava/lang/String;)V

    .line 56
    const-string/jumbo v1, "CREATE TABLE _sync_state (_id INTEGER PRIMARY KEY,account_name TEXT NOT NULL,account_type TEXT NOT NULL,data TEXT,UNIQUE(account_name, account_type));"

    invoke-virtual {p1, v1}, Landroid/database/sqlite/SQLiteDatabase;->execSQL(Ljava/lang/String;)V

    .line 64
    const-string/jumbo v1, "DROP TABLE IF EXISTS _sync_state_metadata"

    invoke-virtual {p1, v1}, Landroid/database/sqlite/SQLiteDatabase;->execSQL(Ljava/lang/String;)V

    .line 65
    const-string/jumbo v1, "CREATE TABLE _sync_state_metadata (version INTEGER);"
    ...
    .line 69
    const-string/jumbo v1, "_sync_state_metadata"
...
.method public delete(Landroid/database/sqlite/SQLiteDatabase;Ljava/lang/String;[Ljava/lang/String;)I
    ...
    .prologue
    .line 92
    const-string/jumbo v0, "_sync_state"
...
.method public onAccountsChanged(Landroid/database/sqlite/SQLiteDatabase;[Landroid/accounts/Account;)V
    ...
    .line 114
    const-string/jumbo v1, "_sync_state"
    ...
    const-string/jumbo v1, "account_name=? AND account_type=?"
...
.method public onDatabaseOpened(Landroid/database/sqlite/SQLiteDatabase;)V
    ...
    .prologue
    .line 74
    const-string/jumbo v2, "SELECT version FROM _sync_state_metadata"
...
.method public update(Landroid/database/sqlite/SQLiteDatabase;JLjava/lang/Object;)I
    ...
    .line 101
    const-string/jumbo v0, "SELECT count(*) FROM _sync_state WHERE _id=?"
    ...
    const-string/jumbo v1, "UPDATE _sync_state SET data=? WHERE _id="
