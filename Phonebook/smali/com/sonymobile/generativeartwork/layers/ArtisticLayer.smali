...
.method private recalcArtTransformation()V
    ...
    .line 293
    iget-object v2, p0, Lcom/sonymobile/generativeartwork/layers/ArtisticLayer;->mMainShapeTransform:[F
    ...
    iget v6, p0, Lcom/sonymobile/generativeartwork/layers/ArtisticLayer;->mLettersScale:F
...
.method public getBaseColor(CC)I
    ...
    .prologue
    .line 162
    new-instance v0, Lcom/sonymobile/generativeartwork/language/LanguageData;

    invoke-direct {v0, p1, p2}, Lcom/sonymobile/generativeartwork/language/LanguageData;-><init>(CC)V
    ...
    invoke-static {v0, v1}, Lcom/sonymobile/generativeartwork/language/LanguageRules;->getColorPaletteId(Lcom/sonymobile/generativeartwork/language/LanguageData;I)I

    move-result v1

    .line 164
    iget-object v0, p0, Lcom/sonymobile/generativeartwork/layers/ArtisticLayer;->mOwner:Lcom/sonymobile/generativeartwork/GenerativeArtWork;

    invoke-virtual {v0}, Lcom/sonymobile/generativeartwork/GenerativeArtWork;->getSettings()Lcom/sonymobile/generativeartwork/settings/LayerSettings;
    ...
    const-string/jumbo v1, "There is no settings in the library."
    ...
    invoke-virtual {v0, v2}, Lcom/sonymobile/generativeartwork/settings/LayerSettings;->containsKey(Lcom/sonymobile/generativeartwork/settings/LayerSettings$Item;)Z
    ...
    const-string/jumbo v1, "Settings don\'t contain the Palette."
    ...
    invoke-virtual {v0, v2}, Lcom/sonymobile/generativeartwork/settings/LayerSettings;->get(Lcom/sonymobile/generativeartwork/settings/LayerSettings$Item;)Ljava/lang/Object;
    ...
    const-string/jumbo v1, "The generated palette Id is less than number of colors."
...
.method public setLetters(CC)V
    ...
    .line 207
    iget-boolean v1, v0, Lcom/sonymobile/generativeartwork/language/LanguageData;->isLanguageAllowed:Z

    if-nez v1, :cond_1

    .line 232
    :cond_0
    iget-object v1, p0, Lcom/sonymobile/generativeartwork/layers/ArtisticLayer;->mLetter:Lcom/sonymobile/generativeartwork/gl/Letter;

    invoke-static {v0}, Lcom/sonymobile/generativeartwork/language/LanguageRules;->getFirstStockImageId(Lcom/sonymobile/generativeartwork/language/LanguageData;)I

    move-result v2

    invoke-static {v0}, Lcom/sonymobile/generativeartwork/language/LanguageRules;->getSecondStockImageId(Lcom/sonymobile/generativeartwork/language/LanguageData;)I

    move-result v3

    invoke-virtual {v1, v2, v3}, Lcom/sonymobile/generativeartwork/gl/Letter;->setTextureStockImageIds(II)V

    .line 234
    iget-object v1, p0, Lcom/sonymobile/generativeartwork/layers/ArtisticLayer;->mLetter:Lcom/sonymobile/generativeartwork/gl/Letter;

    sget-object v2, Lcom/sonymobile/generativeartwork/gl/Letter$Type;->STOCK_IMAGES:Lcom/sonymobile/generativeartwork/gl/Letter$Type;

    invoke-virtual {v1, v2}, Lcom/sonymobile/generativeartwork/gl/Letter;->setLetterType(Lcom/sonymobile/generativeartwork/gl/Letter$Type;)V

    .line 237
    iget-object v1, p0, Lcom/sonymobile/generativeartwork/layers/ArtisticLayer;->mMainShapeTransform:[F

    invoke-static {v1, v4}, Landroid/opengl/Matrix;->setIdentityM([FI)V

    .line 238
    iput-boolean v5, p0, Lcom/sonymobile/generativeartwork/layers/ArtisticLayer;->mIsTransformRecalcNeeded:Z
    ...
    invoke-virtual {v1, v2}, Lcom/sonymobile/generativeartwork/gl/Letter;->setMainShapeTransform([F)V
    ...
    .line 207
    :cond_1
    iget v1, v0, Lcom/sonymobile/generativeartwork/language/LanguageData;->numSkippedLetters:I
    ...
    .line 208
    iget-boolean v1, p0, Lcom/sonymobile/generativeartwork/layers/ArtisticLayer;->mIsTransformRecalcNeeded:Z
    ...
    iget-object v2, v0, Lcom/sonymobile/generativeartwork/language/LanguageData;->mCharacter:[C

    aget-char v2, v2, v4

    iget-object v3, v0, Lcom/sonymobile/generativeartwork/language/LanguageData;->mCharacter:[C

    aget-char v3, v3, v5

    invoke-virtual {v1, v2, v3}, Lcom/sonymobile/generativeartwork/render/FontRenderer;->prepareShapes(CC)V

    .line 218
    iget-object v1, p0, Lcom/sonymobile/generativeartwork/layers/ArtisticLayer;->mFontRenderer:Lcom/sonymobile/generativeartwork/render/FontRenderer;

    invoke-virtual {v1, v4}, Lcom/sonymobile/generativeartwork/render/FontRenderer;->getBoundsLetter(I)Landroid/graphics/RectF;
    ...
    iput v1, p0, Lcom/sonymobile/generativeartwork/layers/ArtisticLayer;->mLettersOffset:F
    ...
    sget-object v2, Lcom/sonymobile/generativeartwork/gl/Letter$Type;->FONT_IMAGE:Lcom/sonymobile/generativeartwork/gl/Letter$Type;
    ...
    .line 210
    iput-boolean v4, p0, Lcom/sonymobile/generativeartwork/layers/ArtisticLayer;->mIsTransformRecalcNeeded:Z
    ...
    sget-object v2, Lcom/sonymobile/generativeartwork/gl/Letter$Type;->FONT_AND_STOCK_IMAGES:Lcom/sonymobile/generativeartwork/gl/Letter$Type;
...
.method public unregisterColorChangeListener(Lcom/sonymobile/generativeartwork/layers/ColorChangeListener;)V
    .locals 1
