...
.method public onServicesReloaded(Ljava/util/List;)V
    ...
    invoke-static {v1}, Lcom/android/settings/notification/ZenModeExternalRuleSettings;->getRuleInfo(Landroid/content/pm/ServiceInfo;)Lcom/android/settings/notification/ZenRuleNameDialog$RuleInfo;
    ...
    iget-object v3, v0, Lcom/android/settings/notification/ZenRuleNameDialog$RuleInfo;->serviceComponent:Landroid/content/ComponentName;

    if-eqz v3, :cond_0

    .line 307
    iget-object v3, v0, Lcom/android/settings/notification/ZenRuleNameDialog$RuleInfo;->settingsAction:Ljava/lang/String;
    ...
    invoke-static {v3}, Lcom/android/settings/notification/ZenModeAutomationSettings;->-get0(Lcom/android/settings/notification/ZenModeAutomationSettings;)Lcom/android/settings/notification/ServiceListing;

    move-result-object v3

    iget-object v4, v0, Lcom/android/settings/notification/ZenRuleNameDialog$RuleInfo;->serviceComponent:Landroid/content/ComponentName;
    ...
    iget-object v5, v0, Lcom/android/settings/notification/ZenRuleNameDialog$RuleInfo;->serviceComponent:Landroid/content/ComponentName;
    ...
    .line 303
    .end local v0    # "ri":Lcom/android/settings/notification/ZenRuleNameDialog$RuleInfo;
