...
.method private createEditDialog(Landroid/os/Bundle;)V
    ...
    invoke-direct {p0, v10}, Lcom/android/settings/sim/SimPreferenceDialog;->customizeSimNameTitle(Landroid/view/View;)V

    .line 144
    iget-object v10, p0, Lcom/android/settings/sim/SimPreferenceDialog;->mDialogLayout:Landroid/view/View;

    const v11, 0x7f13010c
    ...
    .line 158
    :cond_0
    new-instance v10, Lcom/android/settings/sim/SimPreferenceDialog$2;

    invoke-direct {v10, p0, v8}, Lcom/android/settings/sim/SimPreferenceDialog$2;-><init>(Lcom/android/settings/sim/SimPreferenceDialog;Landroid/widget/Spinner;)V
    ...
    invoke-direct {p0, v10}, Lcom/android/settings/sim/SimPreferenceDialog;->customizeDialogTitle(Landroid/app/AlertDialog$Builder;)V
    ...
    invoke-direct {v11, p0, v8}, Lcom/android/settings/sim/SimPreferenceDialog$3;-><init>(Lcom/android/settings/sim/SimPreferenceDialog;Landroid/widget/Spinner;)V
    ...
    invoke-direct {v11, p0}, Lcom/android/settings/sim/SimPreferenceDialog$4;-><init>(Lcom/android/settings/sim/SimPreferenceDialog;)V
    ...
    .line 224
    iget-object v10, p0, Lcom/android/settings/sim/SimPreferenceDialog;->mSimManagementExt:Lcom/mediatek/settings/ext/ISimManagementExt;

    iget-object v11, p0, Lcom/android/settings/sim/SimPreferenceDialog;->mDialogLayout:Landroid/view/View;

    iget-object v12, p0, Lcom/android/settings/sim/SimPreferenceDialog;->mContext:Landroid/content/Context;

    invoke-interface {v10, v11, v12}, Lcom/mediatek/settings/ext/ISimManagementExt;->hideSimEditorView(Landroid/view/View;Landroid/content/Context;)V

    .line 227
    iget-object v10, p0, Lcom/android/settings/sim/SimPreferenceDialog;->mBuilder:Landroid/app/AlertDialog$Builder;

    new-instance v11, Lcom/android/settings/sim/SimPreferenceDialog$5;

    invoke-direct {v11, p0}, Lcom/android/settings/sim/SimPreferenceDialog$5;-><init>(Lcom/android/settings/sim/SimPreferenceDialog;)V
    ...
    new-instance v11, Lcom/android/settings/sim/SimPreferenceDialog$6;

    invoke-direct {v11, p0}, Lcom/android/settings/sim/SimPreferenceDialog$6;-><init>(Lcom/android/settings/sim/SimPreferenceDialog;)V
...
.method private customizeDialogTitle(Landroid/app/AlertDialog$Builder;)V
    .locals 5
    ...
    .line 358
    iget-object v1, p0, Lcom/android/settings/sim/SimPreferenceDialog;->mMiscExt:Lcom/mediatek/settings/ext/ISettingsMiscExt;

    .line 359
    invoke-virtual {p0}, Lcom/android/settings/sim/SimPreferenceDialog;->getResources()Landroid/content/res/Resources;
...
.method private customizeSimNameTitle(Landroid/view/View;)V
    .locals 6
    ...
    .line 344
    .local v1, "nameTitle":Landroid/widget/TextView;
    iget-object v3, p0, Lcom/android/settings/sim/SimPreferenceDialog;->mMiscExt:Lcom/mediatek/settings/ext/ISettingsMiscExt;
    ...
    .line 344
    invoke-interface {v3, v4, v2}, Lcom/mediatek/settings/ext/ISettingsMiscExt;->customizeSimDisplayString(Ljava/lang/String;I)Ljava/lang/String;
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    .line 78
    const-string/jumbo v2, "SimPreferenceDialog"

    const-string/jumbo v3, "mSubInfoRecord is null, finish the activity"
    ...
    iput-object v2, p0, Lcom/android/settings/sim/SimPreferenceDialog;->mMiscExt:Lcom/mediatek/settings/ext/ISettingsMiscExt;
    ...
    iput-object v2, p0, Lcom/android/settings/sim/SimPreferenceDialog;->mSimManagementExt:Lcom/mediatek/settings/ext/ISimManagementExt;
    ...
    iput-object v2, p0, Lcom/android/settings/sim/SimPreferenceDialog;->mSimHotSwapHandler:Lcom/mediatek/settings/sim/SimHotSwapHandler;

    .line 102
    iget-object v2, p0, Lcom/android/settings/sim/SimPreferenceDialog;->mSimHotSwapHandler:Lcom/mediatek/settings/sim/SimHotSwapHandler;

    new-instance v3, Lcom/android/settings/sim/SimPreferenceDialog$1;

    invoke-direct {v3, p0}, Lcom/android/settings/sim/SimPreferenceDialog$1;-><init>(Lcom/android/settings/sim/SimPreferenceDialog;)V
