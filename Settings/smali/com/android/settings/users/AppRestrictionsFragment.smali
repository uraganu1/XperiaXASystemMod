...
.method static synthetic -wrap1(Lcom/android/settings/users/AppRestrictionsFragment;)V
    .locals 0
...
.method static synthetic -wrap2(Lcom/android/settings/users/AppRestrictionsFragment;)V
    .locals 0
...
.method static synthetic -wrap3(Lcom/android/settings/users/AppRestrictionsFragment;Landroid/content/Intent;)V
    .locals 0
...
.method static synthetic -wrap4(Lcom/android/settings/users/AppRestrictionsFragment;Lcom/android/settings/users/AppRestrictionsFragment$AppRestrictionsPreference;Ljava/lang/String;Ljava/util/ArrayList;)V
    .locals 0
    .param p1, "preference"    # Lcom/android/settings/users/AppRestrictionsFragment$AppRestrictionsPreference;
...
.method static synthetic -wrap5(Lcom/android/settings/users/AppRestrictionsFragment;)V
    .locals 0
...
.method private addSystemApps(Ljava/util/List;Landroid/content/Intent;Ljava/util/Set;)V
    ...
    .line 458
    invoke-direct {p0, v6, v11, v9}, Lcom/android/settings/users/AppRestrictionsFragment;->getAppInfoForUser(Ljava/lang/String;ILandroid/os/UserHandle;)Landroid/content/pm/ApplicationInfo;
    ...
    .end local v4    # "info":Lcom/android/settings/users/AppRestrictionsFragment$SelectableAppInfo;
...
.method private addSystemImes(Ljava/util/Set;)V
    ...
    invoke-direct {p0, v6}, Lcom/android/settings/users/AppRestrictionsFragment;->isSystemPackage(Ljava/lang/String;)Z
...
.method private fetchAndMergeApps()V
    ...
    new-instance v22, Lcom/android/settings/users/AppRestrictionsFragment$AppLabelComparator;
    ...
    invoke-direct {v0, v1, v2}, Lcom/android/settings/users/AppRestrictionsFragment$AppLabelComparator;-><init>(Lcom/android/settings/users/AppRestrictionsFragment;Lcom/android/settings/users/AppRestrictionsFragment$AppLabelComparator;)V
    ...
    check-cast v21, Lcom/android/settings/users/AppRestrictionsFragment$SelectableAppInfo;
...
.method private getPackageSummary(Landroid/content/pm/PackageInfo;Lcom/android/settings/users/AppRestrictionsFragment$SelectableAppInfo;)Ljava/lang/String;
    ...
    .line 713
    iget-object v1, p2, Lcom/android/settings/users/AppRestrictionsFragment$SelectableAppInfo;->masterEntry:Lcom/android/settings/users/AppRestrictionsFragment$SelectableAppInfo;

    iget-object v1, v1, Lcom/android/settings/users/AppRestrictionsFragment$SelectableAppInfo;->activityName:Ljava/lang/CharSequence;
...
.method private populateApps()V
    ...
    invoke-direct {v8, v3, v0}, Lcom/android/settings/users/AppRestrictionsFragment$AppRestrictionsPreference;-><init>(Landroid/content/Context;Landroid/view/View$OnClickListener;)V
    ...
    invoke-direct {v0, v1, v8}, Lcom/android/settings/users/AppRestrictionsFragment;->addLocationAppRestrictionsPreference(Lcom/android/settings/users/AppRestrictionsFragment$SelectableAppInfo;Lcom/android/settings/users/AppRestrictionsFragment$AppRestrictionsPreference;)V
    ...
    invoke-direct {v0, v10, v1}, Lcom/android/settings/users/AppRestrictionsFragment;->getPackageSummary(Landroid/content/pm/PackageInfo;Lcom/android/settings/users/AppRestrictionsFragment$SelectableAppInfo;)Ljava/lang/String;
...
.method public onResume()V
    ...
    invoke-direct {v2, p0, v1}, Lcom/android/settings/users/AppRestrictionsFragment$AppLoadingTask;-><init>(Lcom/android/settings/users/AppRestrictionsFragment;Lcom/android/settings/users/AppRestrictionsFragment$AppLoadingTask;)V
