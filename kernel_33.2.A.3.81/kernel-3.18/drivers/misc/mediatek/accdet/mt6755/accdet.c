...
// BSP_Audio_S: B689 20151214 FP019378:Non-CTIA headset warning message
static ssize_t switch_dev_print_name(struct switch_dev *swdev, char *buf);
// BSP_Audio_E: 20151214
...
char *accdet_report_string[4] = {
	...
	"Headset_mic",
	"Headset_no_mic",
	"HEADSET_illegal",  // BSP_Audio_S: B689 20151214 FP019378:Non-CTIA headset warning message
	/* "Double_check"*/
};
/****************************************************************/
/***        export function                                                                        **/
...
#if 0  // BSP_Audio_S: B689 20151214 FP019378:Non-CTIA headset warning message
						cable_type = HEADSET_NO_MIC;
						accdet_status = HOOK_SWITCH;
#else
						cable_type = HEADSET_ILEGAL;
						accdet_status = MIC_BIAS_ILLEGAL;
#endif  // BSP_Audio_E: 20151214
...
#ifdef CONFIG_ACCDET_PIN_RECOGNIZATION
	pmic_pwrap_write(ACCDET_DEBOUNCE0, cust_headset_settings->debounce0);
#if 0  // BSP_Audio_S: B1097 20160130 FP019378:Non-CTIA headset warning message
...
int mt_accdet_probe(struct platform_device *dev)
{
	...
	accdet_data.print_name = switch_dev_print_name;  // BSP_Audio_S: B689 20151214 FP019378:Non-CTIA headset warning message
