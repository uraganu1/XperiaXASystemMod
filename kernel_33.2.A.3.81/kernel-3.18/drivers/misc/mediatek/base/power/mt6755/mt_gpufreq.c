...
#define GPU_DVFS_VOLT0T (112500)	/* mV x 100 */
#define GPU_DVFS_VOLT0	 (110000)	/* mV x 100 */
#define GPU_DVFS_VOLT1   (100000)/* mV x 100 */
#define GPU_DVFS_VOLT2	 (96875)	/* mV x 100 */
#define GPU_DVFS_VOLT3	 (93125)	/* mV x 100 */
#define GPU_DVFS_VOLT4	 (90000)	/* mV x 100 */
#define GPU_DVFS_VOLT5	 (85000)	/* mV x 100 */
...
static struct mt_gpufreq_table_info mt_gpufreq_opp_tbl_e1_0[] = {
	...
	GPUOP(GPU_DVFS_FREQ5, GPU_DVFS_VOLT3, 4),
	GPUOP(GPU_DVFS_FREQ6, GPU_DVFS_VOLT3, 5),
	GPUOP(GPU_DVFS_FREQ7, GPU_DVFS_VOLT4, 6),
	GPUOP(GPU_DVFS_FREQ8, GPU_DVFS_VOLT5, 7),
};

/* Segment2: 550M */
static struct mt_gpufreq_table_info mt_gpufreq_opp_tbl_e1_1[] = {
	GPUOP(GPU_DVFS_FREQ3, GPU_DVFS_VOLT2, 0),
	GPUOP(GPU_DVFS_FREQ4, GPU_DVFS_VOLT2, 1),
	GPUOP(GPU_DVFS_FREQ5, GPU_DVFS_VOLT3, 2),
	GPUOP(GPU_DVFS_FREQ6, GPU_DVFS_VOLT3, 3),
	GPUOP(GPU_DVFS_FREQ7, GPU_DVFS_VOLT4, 4),
	GPUOP(GPU_DVFS_FREQ8, GPU_DVFS_VOLT5, 5),
};

#ifdef MTK_TABLET_TURBO
/* No use in MT6755: 800M Turbo */
static struct mt_gpufreq_table_info mt_gpufreq_opp_tbl_e1_t[] = {
	GPUOP(GPU_DVFS_FREQT, GPU_DVFS_VOLT0T, 0),
	GPUOP(GPU_DVFS_FREQ0, GPU_DVFS_VOLT0, 1),
	GPUOP(GPU_DVFS_FREQ2, GPU_DVFS_VOLT1, 2),
	GPUOP(GPU_DVFS_FREQ4, GPU_DVFS_VOLT2, 3),
	GPUOP(GPU_DVFS_FREQ6, GPU_DVFS_VOLT3, 4),
	GPUOP(GPU_DVFS_FREQ7, GPU_DVFS_VOLT4, 5),
};
#endif
