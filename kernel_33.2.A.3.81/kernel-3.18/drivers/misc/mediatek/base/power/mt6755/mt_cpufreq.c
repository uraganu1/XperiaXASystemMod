...
static struct mt_cpu_freq_info opp_tbl_little_e1_0[] = {
	OP(CPU_DVFS_FREQ0_LL, 108500),
	OP(CPU_DVFS_FREQ1_LL, 102500),
	OP(CPU_DVFS_FREQ2_LL, 97500),
	OP(CPU_DVFS_FREQ3_LL, 95000),
	OP(CPU_DVFS_FREQ4_LL, 90000),
	OP(CPU_DVFS_FREQ5_LL, 85000),
	OP(CPU_DVFS_FREQ6_LL, 83750),
...
static struct mt_cpu_freq_info opp_tbl_little_e2_0[] = {
	...
	OP(CPU_DVFS_FREQ3_LL_SB, 95000),
	OP(CPU_DVFS_FREQ4_LL_SB, 90000),
	OP(CPU_DVFS_FREQ5_LL_SB, 85000),
	OP(CPU_DVFS_FREQ6_LL_SB, 83750),
	OP(CPU_DVFS_FREQ7_LL_SB, 75000),
};

/* CPU LEVEL 0 of L, FY segment */
static struct mt_cpu_freq_info opp_tbl_big_e1_0[] = {
	OP(CPU_DVFS_FREQ0_L, 111250),
	OP(CPU_DVFS_FREQ1_L, 108500),
	OP(CPU_DVFS_FREQ2_L, 102500),
	OP(CPU_DVFS_FREQ3_L, 97500),
	OP(CPU_DVFS_FREQ4_L, 95000),
	OP(CPU_DVFS_FREQ5_L, 90000),
	OP(CPU_DVFS_FREQ6_L, 85000),
...
static struct mt_cpu_freq_info opp_tbl_big_e2_0[] = {
	...
	OP(CPU_DVFS_FREQ3_L_SB, 97500),
	OP(CPU_DVFS_FREQ4_L_SB, 95000),
	OP(CPU_DVFS_FREQ5_L_SB, 90000),
	OP(CPU_DVFS_FREQ6_L_SB, 85000),
