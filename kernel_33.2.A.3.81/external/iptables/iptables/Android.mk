...
LOCAL_POST_INSTALL_CMD := ln -sf /system/bin/iptables $(TARGET_OUT)/bin/iptables-save \
	&& ln -sf /system/bin/iptables $(TARGET_OUT)/bin/iptables-restore
...
LOCAL_POST_INSTALL_CMD := ln -sf /system/bin/ip6tables $(TARGET_OUT)/bin/ip6tables-save \
	&& ln -sf /system/bin/ip6tables $(TARGET_OUT)/bin/ip6tables-restore
