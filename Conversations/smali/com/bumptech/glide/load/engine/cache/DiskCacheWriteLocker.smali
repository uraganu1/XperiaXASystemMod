...
.method release(Lcom/bumptech/glide/load/Key;)V
    ...
    .line 41
    :try_start_0
    iget-object v3, p0, Lcom/bumptech/glide/load/engine/cache/DiskCacheWriteLocker;->locks:Ljava/util/Map;
    ...
    const-string/jumbo v5, "Cannot release a lock that is not held, key: "
    ...
    const-string/jumbo v5, ", interestedThreads: "
    ...
    :cond_2
    :try_start_1
    iget v3, v1, Lcom/bumptech/glide/load/engine/cache/DiskCacheWriteLocker$WriteLock;->interestedThreads:I
